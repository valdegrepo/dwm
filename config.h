...
static const char *fonts[]          = { "Iosevka Term:size=15" };
static const char dmenufont[]       = "Iosevka Term:size=15";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_background, "-nf", col_gray, "-sb", col_violet, "-sf", col_foreground, NULL };
